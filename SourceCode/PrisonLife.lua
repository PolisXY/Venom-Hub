...
local function VKWYL_fake_script() -- Tab1.LocalScript 
...
coroutine.wrap(VKWYL_fake_script)()
local function AEJUBAB_fake_script() -- Tab2.LocalScript 
...
coroutine.wrap(AEJUBAB_fake_script)()
local function KFCEN_fake_script() -- Tab3.LocalScript 
...
coroutine.wrap(KFCEN_fake_script)()
local function SEAEB_fake_script() -- Tab4.LocalScript 
...
coroutine.wrap(SEAEB_fake_script)()
local function SGGS_fake_script() -- Tab5.LocalScript 
...
coroutine.wrap(SGGS_fake_script)()
local function ICWXUAS_fake_script() -- Button1.LocalScript 
...
coroutine.wrap(ICWXUAS_fake_script)()
local function MFXSR_fake_script() -- Button2.LocalScript 
...
coroutine.wrap(MFXSR_fake_script)()
local function BETJWGY_fake_script() -- Button3.LocalScript 
...
coroutine.wrap(BETJWGY_fake_script)()
local function PFLMD_fake_script() -- Button4.LocalScript 
...
coroutine.wrap(PFLMD_fake_script)()
local function LXEQC_fake_script() -- Button5.LocalScript 
...
coroutine.wrap(LXEQC_fake_script)()
local function GTLS_fake_script() -- Button6.LocalScript 
...
coroutine.wrap(GTLS_fake_script)()
local function UJGBVR_fake_script() -- Button7.LocalScript 
...
coroutine.wrap(UJGBVR_fake_script)()
local function NJIYZCG_fake_script() -- Button8.LocalScript 
...
coroutine.wrap(NJIYZCG_fake_script)()
local function NVCTHYF_fake_script() -- Button9.LocalScript 
...
coroutine.wrap(NVCTHYF_fake_script)()
local function UURA_fake_script() -- Button10.LocalScript 
...
coroutine.wrap(UURA_fake_script)()
local function GIIF_fake_script() -- Button1_2.LocalScript 
...
coroutine.wrap(GIIF_fake_script)()
local function BLUT_fake_script() -- Button2_2.LocalScript 
...
coroutine.wrap(BLUT_fake_script)()
local function SZDRKK_fake_script() -- Button3_2.LocalScript 
...
coroutine.wrap(SZDRKK_fake_script)()
local function RVRD_fake_script() -- Button4_2.LocalScript 
...
coroutine.wrap(RVRD_fake_script)()
local function CRUPV_fake_script() -- Button5_2.LocalScript 
...
coroutine.wrap(CRUPV_fake_script)()
local function PYLK_fake_script() -- Button6_2.LocalScript 
...
coroutine.wrap(PYLK_fake_script)()
local function XXCWUTH_fake_script() -- Button1_3.LocalScript 
...
coroutine.wrap(XXCWUTH_fake_script)()
local function QQSI_fake_script() -- Button2_3.LocalScript 
...
coroutine.wrap(QQSI_fake_script)()
local function OJRCS_fake_script() -- Button3_3.LocalScript 
...
coroutine.wrap(OJRCS_fake_script)()
local function JLMWPUB_fake_script() -- Button1_4.LocalScript 
...
coroutine.wrap(JLMWPUB_fake_script)()
local function KIDSCE_fake_script() -- Button2_4.LocalScript 
...
coroutine.wrap(KIDSCE_fake_script)()
local function YUFDMV_fake_script() -- Button3_4.LocalScript 
...
coroutine.wrap(YUFDMV_fake_script)()
local function AQNK_fake_script() -- Button4_3.LocalScript 
...
coroutine.wrap(AQNK_fake_script)()
local function NVTR_fake_script() -- Button5_3.LocalScript 
...
coroutine.wrap(NVTR_fake_script)()
local function WCTTEDD_fake_script() -- Button6_3.LocalScript 
...
coroutine.wrap(WCTTEDD_fake_script)()
local function VLDO_fake_script() -- Button7_2.LocalScript 
...
coroutine.wrap(VLDO_fake_script)()
local function UROEBS_fake_script() -- Button1_5.LocalScript 
...
coroutine.wrap(UROEBS_fake_script)()
local function EUBUNP_fake_script() -- Button2_5.LocalScript 
...
coroutine.wrap(EUBUNP_fake_script)()
local function MYRSS_fake_script() -- Button3_5.LocalScript 
...
coroutine.wrap(MYRSS_fake_script)()
local function OOFOBK_fake_script() -- SettingsButton.LocalScript 
...
coroutine.wrap(OOFOBK_fake_script)()
local function CNXZ_fake_script() -- CloseButton.LocalScript 
...
coroutine.wrap(CNXZ_fake_script)()
local function IQGDHE_fake_script() -- MainFrame.Draggable 
...
coroutine.wrap(IQGDHE_fake_script)()
